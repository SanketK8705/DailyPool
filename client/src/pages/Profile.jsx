...
import { User, Mail, MapPin, Building, Key } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div className="p-6 flex flex-col items-center text-center w-full">
            ...
            <p className="text-xs text-slate-400 mt-1 uppercase tracking-wider">{user?.companyName || 'Commuter'}</p>
            <span className="mt-3 px-3 py-1 bg-slate-950/40 border border-brand-border/60 text-xs font-semibold text-brand-accent rounded-full">
